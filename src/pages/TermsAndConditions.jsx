  ...
  const sections = [
    {
      ...
      title: 'Introduction',
      icon: FileText,
      content: 'Welcome to GreenLand. By accessing or using our website, you agree to comply with and be bound by these Terms & Conditions. Please read them carefully.'
    },
    {
      id: 2,
      title: 'Use of Website',
      icon: Globe,
      content: 'You agree to use GreenLand only for lawful purposes. You must not use our website in any way that may damage, disable, overburden, or impair the site or interfere with any other party\'s use.'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      icon: CreditCard,
      content: 'All payments must be made through secure and trusted channels. GreenLand is not responsible for any third-party transactions.'
    },
    {
      id: 6,
    ...
    },
    {
      ...
      icon: Shield,
      content: 'GreenLand and its affiliates will not be liable for any direct, indirect, incidental, consequential, or punitive damages arising out of your access to or use of the website.'
    },
    {
      id: 8,
    ...
    },
    {
      ...
      title: 'Contact Us',
      icon: Headset,
      content: 'If you have any questions or concerns regarding these Terms & Conditions, please reach out to our support team at support@greenland.com.'
    }
  ];
    ...
    <div className="terms-page-container fade-in">
      ...
      <header className="buyland-header" style={{ marginTop: '1.5rem', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--text-grey)', fontSize: '0.95rem' }}>
          Please read these terms and conditions carefully before using GreenLand.
        </p>
      </header>
